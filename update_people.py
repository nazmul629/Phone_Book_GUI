...
class Update(Toplevel): 
    ...
    def __init__(self,person_id):
        ...
        self.surename_entry.insert(0,person_surename)
    ...
    def update_people(self):
        ...
        query = "update addressbook set person_name = '{}', person_surename = '{}', person_email = '{}', person_phone = {} , person_address = '{}' where person_id = {}".format(name,surename,email,phone,address,person_id)
